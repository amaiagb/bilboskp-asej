            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Solicitud enviada</h1>
                    </div>
                    ...
                    <div class="row mx-1">
						<div class="card shadow mb-4">
                            ...
                            <div class="card-body">
								<p>La solicitud para registrar el centro educativo en BilboSKP ha sido regsitrada.</p>
								<p>Será revisada por nuestro equipo y recibirás una respusta por correo eléctrónico en cuanto esté aceptada.</p>
								<p>¡Gracias!</p>
                            </div>
                        </div>
