	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${suscriptor.rol.nombre == 'centro' ? suscriptor.nombre_centro : suscriptor.nombre}</span>

				<img class="img-profile rounded-circle"
				src="/bilboskp-asej/admin/img/undraw_profile.svg">
		</a> <!-- Dropdown - User Information -->
			<div
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="dropdown-item" href="/bilboskp-asej/logout"> <i
