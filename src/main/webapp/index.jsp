    ...
    <body id="page-top">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <a class="portfolio-link" href="sala-bullying.html">
                                ...
                                <img class="img-fluid " src="assets/img/portfolio/school3.jpg" alt="..." />
                            </a>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/ana.jpeg" alt="..." /></div>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/carlos.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>02-03-2025</h4>
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/david.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>14-03-2025</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/laura.jpeg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>30-03-2025</h4>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aquí podras contactar con nosotros.</h3>
                </div>
                <!-- * * * * * * * * * * * * * * *-->
